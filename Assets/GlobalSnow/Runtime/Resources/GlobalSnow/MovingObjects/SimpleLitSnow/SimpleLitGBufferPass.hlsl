...
#include "../GlobalSnowMovingObject.hlsl"
...
Varyings LitPassVertexSimple(Attributes input)
{
    ...
    output.localPos = vertexInput.positionWS - TransformObjectToWorld(float3(0,0,0));
    return output;
}
...
FragmentOutput LitPassFragmentSimple(Varyings input)
{
    ...
    SetSnowCoverage(input.localPos, color, inputData.normalWS, surfaceData.specular, surfaceData.smoothness);
