...
Shader "Malbers/Color4x4"
{
	...
	SubShader
	{
		...
		{
			float4 color369 = IsGammaSpace() ? float4(1,1,1,1) : float4(1,1,1,1);
			float4 lerpResult370 = lerp( _AO , color369 , i.vertexColor.r);
			float4 saferPower374 = abs( ( lerpResult370 + ( 1.0 - _AOPower ) ) );
			float4 temp_cast_0 = (_AOExp).xxxx;
			float4 clampResult375 = clamp( pow( saferPower374 , temp_cast_0 ) , float4( 0,0,0,0 ) , float4( 1,1,1,0 ) );
			float2 uv_TexCoord256 = i.uv_texcoord * float2( 1,4 );
			float4 temp_cast_1 = (_GradientPower).xxxx;
			...
			float4 clampResult348 = clamp( ( pow( (( ( tex2D( _Gradient, uv_TexCoord256 ) + _GradientColor ) + ( 1.0 - _GradientIntensity ) )*_GradientScale + _GradientOffset) , temp_cast_1 ) + ( 1.0 - (temp_output_329_0).a ) ) , float4( 0,0,0,0 ) , float4( 1,1,1,1 ) );
			o.Albedo = ( clampResult375 * ( clampResult348 * temp_output_329_0 * _Tint ) ).rgb;
...
Node;AmplifyShaderEditor.ColorNode;266;-707.4464,1526.003;Float;False;Property;_Color15;Color 15;18;0;Create;True;0;0;0;False;0;False;1,0,0,0.391;0,0,0,0;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;263;-1349.037,1505.674;Float;False;Property;_Color11;Color 11;14;0;Create;True;0;0;0;False;0;False;0.6691177,0.6691177,0.6691177,0.647;0.4713866,0.8135816,0.9339623,1;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;269;-1353.199,1714.419;Float;False;Property;_Color12;Color 12;15;0;Create;True;0;0;0;False;0;False;0.5073529,0.1574544,0,0.128;0.1698113,0.1481844,0.1481844,1;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;271;-1360.466,759.4822;Float;False;Property;_Color4;Color 4;7;0;Create;True;0;0;0;False;0;False;0.1544118,0.5451319,1,0.253;0.7924528,0.7924528,0.7924528,1;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;260;-711.3392,1318.291;Float;False;Property;_Color14;Color 14;17;0;Create;True;0;0;0;False;0;False;0,0.8025862,0.875,0.047;0,0,0,0;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;258;-697.8932,1107.106;Float;False;Property;_Color13;Color 13;16;0;Create;True;0;0;0;False;1;Space(10);False;1,0.5586207,0,0.272;1,1,1,1;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;257;-722.6031,131.1891;Float;False;Property;_Color5;Color 5;8;0;Create;True;0;0;0;False;1;Space(10);False;0.9533468,1,0.1544118,0.553;0.735849,0.6968004,0.6837842,0.1764706;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;273;-700.0488,1737.502;Float;False;Property;_Color16;Color 16;19;0;Create;True;0;0;0;False;0;False;0.4080882,0.75,0.4811866,0.134;0,0,0,0;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;275;-1349.185,341.859;Float;False;Property;_Color2;Color 2;5;0;Create;True;0;0;0;False;0;False;1,0.1544118,0.8017241,0.253;0.8490566,0.8190192,0.7649519,0.091;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;265;-1345.374,133.4282;Float;False;Property;_Color1;Color 1;4;0;Create;True;0;0;0;False;1;Header(Albedo (A Gradient));False;1,0.1544118,0.1544118,0.291;0.7547169,0.7052519,0.6372375,0.4823529;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;267;-736.2856,561.0974;Float;False;Property;_Color7;Color 7;10;0;Create;True;0;0;0;False;0;False;0.1544118,0.6151115,1,0.178;0.6981132,0.4247953,0.4323178,0.4196078;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;262;-723.931,778.1015;Float;False;Property;_Color8;Color 8;11;0;Create;True;0;0;0;False;0;False;0.4849697,0.5008695,0.5073529,0.078;0.6603774,0.5015129,0.5150015,0.5176471;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;274;-1344.989,1084.025;Float;False;Property;_Color9;Color 9;12;0;Create;True;0;0;0;False;1;Space(10);False;0.3164301,0,0.7058823,0.134;0.5471698,0.4310252,0.4310252,0.6509804;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;268;-1347.424,1291.078;Float;False;Property;_Color10;Color 10;13;0;Create;True;0;0;0;False;0;False;0.362069,0.4411765,0,0.759;0.9056604,0.8039787,0.5681738,0.4745098;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;261;-1354.927,549.5719;Float;False;Property;_Color3;Color 3;6;0;Create;True;0;0;0;False;0;False;0.2535501,0.1544118,1,0.541;0.7169812,0.7169812,0.7169812,0.6039216;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;272;-727.791,345.1252;Float;False;Property;_Color6;Color 6;9;0;Create;True;0;0;0;False;0;False;0.2720588,0.1294625,0,0.097;0.5471698,0.4142732,0.3639195,0.4901961;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ColorNode;264;844.9053,47.40545;Float;False;Property;_GradientColor;Gradient Color;39;0;Create;True;0;0;0;False;0;False;0,0,0,0;0.6509434,0.5635368,0.4636436,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;270;816.5891,230.7126;Float;False;Property;_GradientIntensity;Gradient Intensity;38;0;Create;True;0;0;0;False;0;False;1;1;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;311;-869.2375,2410.001;Float;False;Property;_MRE7;MRE 7;26;0;Create;True;0;0;0;False;0;False;0,1,0,0;0,1,0.05490194,0;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;298;-1349.235,3336.623;Float;False;Property;_MRE12;MRE 12;31;0;Create;True;0;0;0;False;0;False;0,1,0,0;0,1,0,0;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;305;-1363.989,2223.768;Float;False;Property;_MRE2;MRE 2;21;0;Create;True;0;0;0;False;0;False;0,1,0,0;0,1,0,0;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;308;-1363.03,2395.617;Float;False;Property;_MRE3;MRE 3;22;0;Create;True;0;0;0;False;0;False;0,1,0,0;0.5333333,0.6745098,0.03921569,0;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;312;-875.2134,2580.248;Float;False;Property;_MRE8;MRE 8;27;0;Create;True;0;0;0;False;0;False;0,1,0,0;0,0.6666667,0,0;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;313;-1365.449,2057.625;Float;False;Property;_MRE1;MRE 1;20;0;Create;True;0;0;0;False;1;Header(Metallic(R) Rough(G) Emmission(B));False;0,1,0,0;0.3490196,1,0,0;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;309;-874.2711,2070.23;Float;False;Property;_MRE5;MRE 5;24;0;Create;True;0;0;0;False;1;Space(10);False;0,1,0,0;0,1,0.03921569,0;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;314;-1360.115,2564.694;Float;False;Property;_MRE4;MRE 4;23;0;Create;True;0;0;0;False;0;False;0,1,0,0;0,1,0.03921569,0;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;307;-865.3842,2837.277;Float;False;Property;_MRE13;MRE 13;32;0;Create;True;0;0;0;False;1;Space(10);False;0,1,0,0;0,0,0.6313726,1;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;304;-873.5535,2240.293;Float;False;Property;_MRE6;MRE 6;25;0;Create;True;0;0;0;False;0;False;0,1,0,0;0,1,0.03921569,0;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;294;-869.8051,3185.809;Float;False;Property;_MRE15;MRE 15;34;0;Create;True;0;0;0;False;0;False;0,1,0,0;0,0,0,1;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;301;-1354.192,3164.495;Float;False;Property;_MRE11;MRE 11;30;0;Create;True;0;0;0;False;0;False;0,1,0,0;0.5019608,0.5960784,0.3058823,0;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;306;-1356.103,2816.068;Float;False;Property;_MRE9;MRE 9;28;0;Create;True;0;0;0;False;1;Space(10);False;0,1,0,0;0,1,0.7294118,0;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;297;-863.7613,3009.661;Float;False;Property;_MRE14;MRE 14;33;0;Create;True;0;0;0;False;0;False;0,1,0,0;0,0,0,1;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;300;-864.2806,3358.549;Float;False;Property;_MRE16;MRE 16;35;0;Create;True;0;0;0;False;0;False;0,1,0,0;0,0,0,1;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;310;-1352.963,2989.84;Float;False;Property;_MRE10;MRE 10;29;0;Create;True;0;0;0;False;0;False;0,1,0,0;0.3058823,0.462745,0.1843137,1;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;326;1351.87,149.2626;Float;False;Property;_GradientOffset;Gradient Offset;41;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;325;1345.052,56.51933;Float;False;Property;_GradientScale;Gradient Scale;40;0;Create;True;0;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.CommentaryNode;367;3056,-96;Inherit;False;1043.325;717.015;Vertex Ambient Oclusion;11;368;373;369;378;375;374;372;371;370;377;376;;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.RangedFloatNode;338;1356.361,245.6984;Float;False;Property;_GradientPower;Gradient Power;42;0;Create;True;0;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;376;3088,-48;Inherit;False;Property;_AO;AO;0;0;Create;True;0;0;0;False;0;False;1,1,1,1;1,1,1,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.VertexColorNode;377;3088,304;Inherit;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;369;3088,128;Inherit;False;Constant;_White;White;2;0;Create;True;0;0;0;False;0;False;1,1,1,1;1,1,1,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;368;3088,480;Inherit;False;Property;_AOPower;AO Power;1;0;Create;True;0;0;0;False;0;False;0;0.47;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.LerpOp;370;3344,32;Inherit;True;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.OneMinusNode;371;3360,256;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleAddOpNode;372;3632,32;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.RangedFloatNode;373;3616,176;Inherit;False;Property;_AOExp;AO Exp;2;0;Create;True;0;0;0;False;0;False;0;1.5;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;345;1605.128,1601.318;Inherit;False;Property;_EmissionPower;Emission Power;36;0;Create;True;0;0;0;False;1;Header(Emmision);False;1;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;357;2246.987,613.945;Float;False;Property;_Tint;Tint;3;0;Create;True;0;0;0;False;0;False;1,1,1,1;0.8207547,0.8207547,0.8207547,1;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.PowerNode;374;3760,32;Inherit;False;True;2;0;COLOR;0,0,0,0;False;1;FLOAT;1;False;1;COLOR;0
...
Node;AmplifyShaderEditor.ClampOpNode;375;3936,32;Inherit;False;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;COLOR;1,1,1,0;False;1;COLOR;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;353;2848,720;Inherit;True;3;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;378;3824,288;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.StandardSurfaceOutputNode;0;3722.291,1294.892;Float;False;True;-1;7;ASEMaterialInspector;0;0;Standard;Malbers/Color4x4;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;Off;0;False;;0;False;;False;0;False;;0;False;;False;0;Opaque;0.1;True;True;0;False;Opaque;;Geometry;ForwardOnly;12;all;True;True;True;True;0;False;;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;2;15;10;25;False;0.5;True;0;0;False;;0;False;;0;0;False;;0;False;;0;False;;0;False;;0;False;0;0,0,0,0;VertexOffset;True;False;Cylindrical;False;True;Relative;0;;-1;-1;-1;-1;0;False;0;0;False;;-1;0;False;;0;0;0;False;0.1;False;;0;False;;False;17;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;2;FLOAT3;0,0,0;False;3;FLOAT;0;False;4;FLOAT;0;False;5;FLOAT;0;False;6;FLOAT3;0,0,0;False;7;FLOAT3;0,0,0;False;8;FLOAT;0;False;9;FLOAT;0;False;10;FLOAT;0;False;13;FLOAT3;0,0,0;False;11;FLOAT3;0,0,0;False;12;FLOAT3;0,0,0;False;16;FLOAT4;0,0,0,0;False;14;FLOAT4;0,0,0,0;False;15;FLOAT3;0,0,0;False;0
...
ASEEND*/
//CHKSM=1FC5BE2A2BF2C2341E98FD711E468243BC929C2E